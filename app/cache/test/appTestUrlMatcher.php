...
class appTestUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        // upload
        if ($pathinfo === '/upload') {
            return array (  '_controller' => 'Cassio\\EvalBundle\\Controller\\DefaultController::uploadAction',  '_route' => 'upload',);
        }

        // tc
        if ($pathinfo === '/tc') {
            return array (  '_controller' => 'Cassio\\EvalBundle\\Controller\\DefaultController::showTCAction',  '_route' => 'tc',);
        }
